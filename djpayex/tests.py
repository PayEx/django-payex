...
class InitializedPaymentTests(TestCase):
    ...
    def testManagerCreateResponse(self):
        ...
        response = {'status': {'errorCode': 'OK', 'code': 'OK', 'description': 'OK', 'thirdPartyError': None, 'paramName': None}, 'header': {'date': '2011-10-07 12:35:34', 'name': 'Payex Header v1.0', 'id': 'a3a2da2c9cdd4aebbcaa6b609df6fd52'}, 'sessionRef': '5996a5a093af4820a8c5755a73e6e76b', 'redirectUrl': 'https://test-account.payex.com/MiscUI/PxMenu.aspx?orderRef=c59cc7c7cc0c4194b1e21c27d6ba4074', 'orderRef': 'c59cc7c7cc0c4194b1e21c27d6ba4074'}
...
class TransactionStatusTests(TestCase):
    ...
    def testManagerCreateResponseUnfinished(self):
        ...
        response = {'status': {'errorCode': 'Order_OrderProcessing', 'code': 'Order_OrderProcessing', 'description': 'The user has not initialized the purchase yet', 'thirdPartyError': None, 'paramName': None}, 'header': {'date': '2011-10-07 12:53:53', 'name': 'Payex Header v1.0', 'id': 'd9d4c533c8484a7c8141fda341e830e1'}, 'orderStatus': '1'}
    ...
    def testManagerCreateResponseCompleted(self):
        ...
        response = {'status': {'errorCode': 'OK', 'code': 'OK', 'description': 'OK', 'thirdPartyError': None, 'paramName': None}, 'orderId': 'test1', 'transactionNumber': '40276785', 'clientAccount': '0', 'pending': False, 'alreadyCompleted': False, 'clientGsmNumber': None, 'productNumber': '123', 'AuthenticatedStatus': '3DSecure', 'maskedNumber': '41**********1111', 'header': {'date': '2011-10-07 12:59:30', 'name': 'Payex Header v1.0', 'id': 'efb64f26a27449b9bd513f949a077080'}, 'amount': '5000', 'fraudData': False, 'orderStatus': '0', 'AuthenticatedWith': 'Y', 'transactionRef': 'e4ee430eba5a4cdb85f7e81a93c2e424', 'transactionStatus': '0', 'paymentMethod': 'VISA', 'BankHash': '12300001-4111-1111-1111-000000000000', 'productId': '123'}
